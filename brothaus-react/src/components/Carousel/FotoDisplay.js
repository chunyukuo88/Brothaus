...
export default function FotoDisplay(){
  return(
    <CarouselDisplay>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/1-min.jpg" />
        <p className="legend">"We just did."</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/2-min.jpg" />
        <p className="legend">Cut mirchi at my favorite restaurant: Neehee's!</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/3-min.jpg" />
        <p className="legend">I downloaded this beautiful game to celebrate Halloween with The Fourth.</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/4-min.jpg" />
        <p className="legend">Mugi's seasonal handiwork.</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/5-min.jpg" />
        <p className="legend">I tried khaman, a savory Gujarati cake.</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/6-min.jpg" />
      ...
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/7-min.jpg" />
        <p className="legend">After procrastinating for more than a year, I got this along with an updated driver's license.</p>
      </div>
      <div>
        <img alt="" src="https://woobler-photos.s3.amazonaws.com/8-min.jpg" />
